...
public class NGramMapTest {
    ...
    public static void main(String args[]){
        ...
        List<String> fishAndDog = new ArrayList<>();
        fishAndDog.add("fish");
        //System.out.println(ngm.summedWeightHistory(fishAndDog,1865,1866).toString());
        System.out.println(ngm.countHistory("fish",1865,1866).toString());
        /*System.out.println(ngm.totalWords(1865,1865,1));
        System.out.println(ngm.totalWords1(1950,1990));*/
    }
